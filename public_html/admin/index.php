...
?>
<!-- header（Start） -->
<?php include ROOT . 'include/admin/header.php'; ?>
<!-- header（End） -->
...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <h1 id="sidebar-title"><a href="#">VArts Admin</a></h1>
      <!-- Logo (221px wide) -->
      <a href="#"><img id="logo" src="resources/images/bg_logo_vane360_font.png" alt="VArts Admin logo" /></a>
